...
class TestAttachmentEncrypted:
    ...
    def test_download_update_bad_change_encrypted(self, encrypted_testapp, href, mock_aws_env):
        item = {'attachment': {
            'download': 'red-dot.png',
            'href': href,
        }}
    ...
    def test_download_create_bad_change_encrypted(self, encrypted_testapp, href, mock_aws_env):
        item = {'attachment': {
            'download': 'red-dot.png',
            'href': href,
        }}
