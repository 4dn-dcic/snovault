...
class TestAttachmentEncrypted:
    ...
    @mock_s3
    def test_download_create(self, encrypted_testapp):
    ...
    @mock_s3
    def test_download_update(self, encrypted_testapp):
        item = {
            'attachment': {
                'download': 'blue-dot.png',
                'href': BLUE_DOT,
    ...
    @mock_s3
    def test_download_update_no_change(self, encrypted_testapp):
        item = {
            'attachment': {
                'download': 'red-dot.png',
                'href': '@@download/attachment/red-dot.png',
    ...
    @mock_s3
    def test_download_update_one(self, encrypted_testapp):
        item = {
            'attachment': {
                'download': 'red-dot.png',
                'href': '@@download/attachment/red-dot.png',
    ...
    @mock_s3
    def test_download_update_with_premade_href(self, encrypted_testapp):
        """
        Test the functionality of PATCHing the attachment information directly
        (which is usually generated by the propsheet)
        """
    ...
    @mock_s3
    def test_download_remove_one(self, encrypted_testapp):
        item = {
            'attachment': {
                'download': 'red-dot.png',
                'href': '@@download/attachment/red-dot.png',
    ...
    def test_download_update_bad_change(self, encrypted_testapp, href):
        item = {'attachment': {
            'download': 'red-dot.png',
            'href': href,
        }}
    ...
    def test_download_create_bad_change(self, encrypted_testapp, href):
        item = {'attachment': {
            'download': 'red-dot.png',
            'href': href,
        }}
    ...
    @mock_s3
    def test_download_create_wrong_extension(self, encrypted_testapp):
        item = {'attachment': {
            'download': 'red-dot.jpg',
            'href': RED_DOT,
        }}
    ...
    @mock_s3
    def test_download_create_w_wrong_md5sum(self, encrypted_testapp):
        item = {'attachment': {
            'download': 'red-dot.jpg',
            'href': RED_DOT,
            'md5sum': 'deadbeef',
